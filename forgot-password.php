            ...
            <div class="glass-card form auth-card modern-auth-card">
                ...
                <?php elseif ($step === 'verify'): ?>
                    <form method="post" action="">
                        ...
                        <div class="auth-switch" style="text-align: center; margin-top: 20px; font-size: 14px; color: var(--muted);">
                            Didn't get code? <a href="<?php echo $baseUrl; ?>forgot-password.php" style="color: var(--blue); font-weight: 800; text-decoration: none;">Resend code -></a>
                        </div>
                    </form>
                ...
                <?php else: ?>
                    <form method="post" action="">
                        ...
                        <div class="auth-switch" style="text-align: center; margin-top: 20px; font-size: 14px; color: var(--muted);">
                            Remembered password? <a href="<?php echo $baseUrl; ?>login.php" style="color: var(--blue); font-weight: 800; text-decoration: none;">Return to login -></a>
                        </div>
                    </form>
                <?php endif; ?>
            </div>
