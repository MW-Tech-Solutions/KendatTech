        ...
        <div class="auth-form-panel">
            <form class="glass-card form auth-card modern-auth-card register-card" method="post" action="">
                ...
                <div class="auth-switch" style="text-align: center; margin-top: 20px; font-size: 14px; color: var(--muted);">
                    Already registered? <a href="<?php echo $baseUrl; ?>login.php" style="color: var(--blue); font-weight: 800; text-decoration: none; display: inline-flex; align-items: center; gap: 4px;">Login to Portal <?php echo render_icon('ArrowRight', 14); ?></a>
                </div>
            </form>
        </div>
    </section>
